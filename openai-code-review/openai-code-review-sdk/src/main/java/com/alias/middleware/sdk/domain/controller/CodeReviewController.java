package com.alias.middleware.sdk.domain.controller;

import com.alias.middleware.sdk.config.AppConfig;
import com.alias.middleware.sdk.domain.model.ModelEnum;
import com.alias.middleware.sdk.domain.model.Response;
import com.alias.middleware.sdk.domain.model.ReviewRequest;
...
public class CodeReviewController {
    ...
    public Response<String> reviewPullRequest(@RequestBody ReviewRequest request) {
        try {
            ...
            String openaiApiHost = cfg.requireString("openai", "apiHost");
            String openaiApiKey = cfg.requireString("openai", "apiKey");

            // 创建依赖
            GitCommand gitCommand = new GitCommand(githubToken);
            IOpenAI openAI = new OpenAI(openaiApiHost, openaiApiKey);
    ...
    public Response<ModelEnum[]> getSupportedModels() {
        try {
            ...
            return Response.<ModelEnum[]>builder()
                    .code("0000")
                    .info("Success")
                    .data(models)
                    .build();
            ...
            return Response.<ModelEnum[]>builder()
                    .code("5000")
                    .info("Failed to get models: " + e.getMessage())
                    .build();
        }
    }
